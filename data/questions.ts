...
export const FLAVOR_PROFILE_QUESTIONS: SliderQuestionConfig[] = [
  ...
  q({ id: "flavor_spice", section: "flavor_profile", title: "你接受香料感嗎？", helper: "這裡是香料層次，不等於辣度，也會補足你偏溫和還是重口。", leftLabel: "不太要", rightLabel: "很可以", required: true }),
...
export const NOODLE_QUESTIONS: SliderQuestionConfig[] = [
  q({ id: "noodle_thickness", section: "noodle", title: "你喜歡細麵還是粗麵？", helper: "粗細對流派辨識非常重要，也會直接決定你的麵體軸。", leftLabel: "細麵", rightLabel: "粗麵", required: true }),
  q({ id: "noodle_firmness", section: "noodle", title: "你喜歡偏軟還是偏硬？", helper: "這題反映口感偏好，也會補足麵體的厚實感。", leftLabel: "偏軟", rightLabel: "偏硬", required: true }),
...
export const TOPPING_QUESTIONS: SliderQuestionConfig[] = [
  ...
  q({ id: "topping_garlic", section: "topping", title: "你想要蒜嗎？", helper: "這題會補足你對重口與刺激感的接受度。", leftLabel: "不太想要", rightLabel: "非常想要", required: false }),
  q({ id: "topping_backfat", section: "topping", title: "你想要背脂／油脂感嗎？", helper: "這題會補足你對重口與油脂衝擊感的接受度。", leftLabel: "不太想要", rightLabel: "非常想要", required: false }),
